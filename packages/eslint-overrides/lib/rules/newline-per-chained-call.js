...
module.exports = {
    ...
    create(context) {
         ...
         * @returns {bool} A node containing the entire statement.
         */
                ...
                hasObjectAndPropertyOnSameLine(node) && (
                    memberExpressions.length > ignoreChainWithDepth || (
                        ...
                        memberExpressions.length <= ignoreChainWithDepth && (
                            ...
                            /*
                             * console.log(node.property.loc.start.line, (memberExpressions[memberExpressions.length - 1] || {}).property.loc.start.line)||
                             * (
                             *     multilineBreakStyle === "object" &&
                             *     node.property.loc.start.line !== (memberExpressions[memberExpressions.length - 1] || {}).object.parent.property.loc.start.line
                             * ) || (
                             *     multilineBreakStyle === "statement" &&
                             *     node.loc.end.line !== getStatementChildNode(node).loc.end.line
                             * )
                             */
                            (
                                multilineBreakStyle === "object" &&
